...
#' Use only companies listed on the NASDAQ, NYSE, and AMEX with a market capitalization of $10 billion or greater. 
list_clean <- read_csv("./data/list-all.csv") %>% 
...
ohlc_data <- download_yahoo_many(symbols = c(list_clean[["symbol"]], "CVE.TO", "POT.TO", "SSL.TO", "VET.TO", "RST"), 
                                 from = "2014-01-01", 
                                 to = Sys.Date()) 
