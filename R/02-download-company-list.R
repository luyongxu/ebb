...
#' Description  
#' Downloads a list of all companies listed on an exchange. For companies listed on NASDAQ, NYSE, and AMEX, uses 
#' the company list at http://www.nasdaq.com/screening/company-list.aspx and contains data about the company name, 
#' symbol, market cap, ipo year, sector, and industry. For companies listed on TSX, uses the company list at 
#' https://www.tsx.com/json/company-directory/search/tsx/ and only contains data about the company name and symbol. 
#' 
#' Arguments  
...
download_company_list <- function(exchange) { 
  ...
  # For companies listed on TSX, use the company list at https://www.tsx.com/json/company-directory/search/tsx/
  if (exchange == "tsx") { 
